...
asena.addCommand({pattern: 'gdnight', fromMe: true, deleteCommand: true, desc: GN,}, (async (message, match) => {
    ...
    if (Config.WORKTYPE == 'public') {
        ...
        asena.addCommand({pattern: 'gdnight', fromMe: false, deleteCommand: true, desc: GN,}, (async (message, match) => {
                ...
                asena.addCommand({pattern: 'gdmrng', fromMe: true, deleteCommand: true,dontAddCommandList: false }, (async (message, match) => {
                ...
                asena.addCommand({pattern: 'gdnight', fromMe: true, deleteCommand: true,dontAddCommandList: false }, (async (message, match) => {
